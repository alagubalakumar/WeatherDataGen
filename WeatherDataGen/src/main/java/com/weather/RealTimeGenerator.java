...
public class RealTimeGenerator {
    ...
    static String[] citiesArr = {"Melbourne","Brisbane","Perth","Adelaide","Canberra","Hobart","Darwin"};
	...
	public  void getData(String outputDataDir) {
		try {
	 ...
	 * @return
	 */
	private static Map<String,String> getCities(){
